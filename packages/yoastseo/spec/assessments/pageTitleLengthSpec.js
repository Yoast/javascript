import PageTitleLengthAssessment from "../../src/assessments/seo/PageTitleLengthAssessment.js";
...
describe( "the SEO title length assessment", function() {
	it( "should assess a paper without a <a href='https://yoa.st/2po' target='_blank'>SEO title</a>", function() {
		...
		expect( result.getText() ).toEqual( "<a href='https://yoa.st/34h' target='_blank'>SEO title length</a>: <a href='https://yoa.st/34i' target='_blank'>Please create an SEO title</a>." );
	} );
	...
	it( "should assess a paper with a SEO title that's under the recommended value", function() {
		...
		expect( result.getText() ).toEqual( "<a href='https://yoa.st/34h' target='_blank'>SEO title length</a>: The SEO title is too short. <a href='https://yoa.st/34i' target='_blank'>Use the space to add keyphrase variations or create compelling call-to-action copy</a>." );
	} );
	...
	it( "should assess a paper with a SEO title that's in range of the recommended value", function() {
		...
		expect( result.getText() ).toEqual( "<a href='https://yoa.st/34h' target='_blank'>SEO title length</a>: Good job!" );
	} );
	...
	it( "should assess a paper with a SEO title that's longer than the recommended value", function() {
		...
		expect( result.getText() ).toEqual( "<a href='https://yoa.st/34h' target='_blank'>SEO title length</a>: The SEO title is wider than the viewable limit. <a href='https://yoa.st/34i' target='_blank'>Try to make it shorter</a>." );
	} );
} );
