...
const wordsToStemWithoutFunctionWords = filterFunctionWordsFromArray( wordsToStem, "in" );

describe( "Generate stems for Indonesian words", () => {
	const corpusWithStems = wordsToStemWithoutFunctionWords.map( word => [ word, stem( word, morphologyDataIN ) ] );
